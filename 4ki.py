...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย Selfbot By ❍Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭✯͜͡❂➣ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับ❍Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭✯͜͡❂➣ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
...
╠❂➣ เปิดส่งแขก/ปิดส่งแขก
╠❂➣ เปิดทักเตะ/ปิดทักเตะ
╔┅➴͜͜BoTสายหมอบ✯͜͡❦┅┓                                                    ╠❂➣ ปฏิทิน                                                            ╠❂➣ รูปภาพ [ชอรปภาพ]                                                 ╠❂➣ คนหารปภาพ [ชอรปภาพ]                                             ╠❂➣ ยูทูป [ขอความ]
╠❂➣ เพลง [ชอเพลง]
╠❂➣ Lyric
╠❂➣ ScreenshootWebsite
╠❂➣ หนัง [ชื่อหนัง]
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            line.sendMessage(to, "ลิ้งของกลุ่ม\nhttp://line.me/ti/p/y3Xm5Inw0y/{}".format(str(ticket)))
                ...
                elif "Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭" in msg.text:
                    spl = msg.text.split("Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭")
                    if spl[len(spl)-1] == "":
                        line.sendText(msg.to,"กด😎😎😎?chatId="+msg.to+"&messageId="+msg.id)
...
#==============================================================================#   
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "❍✯Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭✯͜͡❂➣\n👇ตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว ดังนี้👇\n\n👉{}".format(str(spl)))
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "❍✯Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭✯❂➣\n👇ตั้งข้อความคอมเม้นของคุณแล้ว ดังนี้👇\n\n👉{}".format(str(spl))) 
...
#=============COMMAND KICKER===========================#
                    ...
                    settings["blacklist"] = {}
                    line.sendMessage(msg.to,"ระบบได้ทำการล้างหำให้คุณเรียร้อย")
                    print ("Clear Ban")
...
#==============FINNISHING PROTECT========================#
                ...
                elif msg.text in [".เช็คหำ"]:
                  if msg._from in Family:
                    if settings["blacklist"] == {}:
                        line.sendMessage(msg.to,"ไม่พบ") 
                    else:
                        line.sendMessage(msg.to,"รายชื่อผู้ติดหำ")
                        mc = "Blacklist User\n"
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in [".ประกาศ","โฆษณา","ประชาสัมพัน"]:
                	line.sendText(msg.to,"Ŧ€₳M↬฿❂Ŧ↬สายหมอบ🇹🇭")
