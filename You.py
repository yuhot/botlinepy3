...
settings = {
    ...
    "man2":"ตั้งข้อความ",
    "man3":"ตั้งข้อความ",
    "message":"บัญชีนี้ได้การป้องกันโดย ™❍✯͜͡YOU-BOT✯͜͡❂➣  ระบบได้ทำการบล็อคคุณอัตโนมัติ\nติดต่อเชลบอทรึบอทวี10คอมเม้นในโพสเลยคับ",
    "comment":"™❍✯͜͡YOU-BOT✯͜͡❂➣",
    "userAgent": [
...
🎭เปิดหมด ➠ ป้องกันทั้งหมด
🎭ปิดหมด ➠ ป้องกันทั้งหมด
🎭กันเชิญ ➠ ป้องกันเชิญ
🎭ปิดกันเชิญ ➠ ป้องกันเชิญ
🎭กันลิ้ง ➠ ป้องกันลิ้ง
🎭ปิดกันลิ้ง ➠ ป้องกันลิ้ง
🎭กันกลุ่ม ➠ ป้องกันกลุ่ม
🎭ปิดกันกลุ่ม ➠ ป้องกันกลุ่ม
🎭กันเข้า ➠ ป้องกันเข้า
🎭ปิดกันเข้า ➠ ป้องกันเข้า
🎭กันเตะ ➠ ป้องกันเตะ
🎭ปิดกันเตะ ➠ ป้องกันเตะ
🎭แทคเตะ ➠ เปิดแทคเตะ
🎭ปิดแทคเตะ ➠ ปิดแทคเตะ
🎭กลุ่ม ➠ ข้อมูลกลุ่ม
🎭ไอดีกลุ่ม ➠ไอดีห้อง
🎭ชื่อกลุ่ม ➠ ชื่อห้อง
🎭ชื่อกลุ่ม ➠ เปลี่ยนชื่อห้อง
🎭รูปกลุ่ม ➠ รูปกลุ่ม
🎭บ้าน ➠ ดูรายชื่อกลุ่ม
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, "👍〘บอทยังอยู่ครับท่านยู〙👍")
                    ...
                    line.sendMessage(to, "〘™❍✯͜͡YOU-BOT✯͜͡❂➣ 〙\n""ระยะเวลาการทำงานของบอท {}".format(str(runtime)))
                elif text.lower() == 'บอท':
                    try:
                        arr = []
                        owner = "u06779df38010e6e1509ca0499acaa501"
...
#==============================================================================#
                ...
                elif text.lower() == 'แทคเจ็บ':
                    settings["kickMention"] = True
                    line.sendMessage(to, "👍เปิดระบบเตะคนแทค👎")
                elif text.lower() == 'ปิดแทคเจ็บ':
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u06779df38010e6e1509ca0499acaa501")
                elif text.lower() == 'มิด':
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["me","คท","Me",".คท","!me","/me"]:
                    line.sendText(msg.to,"👣เชคทั้งวันเลยนะบักหำ👣")
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"👍รู้แล้วว่าแรงเช็ดอยู่ได้บักหำ👍")
                if msg.text in ["พี่ยู","ท่านยู"]:
                    line.sendText(msg.to,"ท่านยูไม่อยู่มีอะไรฝากบอทไว้เลยบักหำ")
                if msg.text in ["แทค"]:
